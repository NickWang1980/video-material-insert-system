...
def ensure_data_layout(settings: Settings) -> None:
    ...
    (data_dir / "uploads" / "materials" / "general" / "images").mkdir(parents=True, exist_ok=True)
    (data_dir / "uploads" / "materials" / "general" / "gifs").mkdir(parents=True, exist_ok=True)
    (data_dir / "uploads" / "materials" / "general" / "videos").mkdir(parents=True, exist_ok=True)
    (data_dir / "uploads" / "materials" / "general" / "audios").mkdir(parents=True, exist_ok=True)
    (data_dir / "uploads" / "materials" / "unfiled" / "images").mkdir(parents=True, exist_ok=True)
    (data_dir / "uploads" / "materials" / "unfiled" / "gifs").mkdir(parents=True, exist_ok=True)
    (data_dir / "uploads" / "materials" / "unfiled" / "videos").mkdir(parents=True, exist_ok=True)
    (data_dir / "uploads" / "materials" / "unfiled" / "audios").mkdir(parents=True, exist_ok=True)
    (data_dir / "uploads" / "materials" / "products").mkdir(parents=True, exist_ok=True)
