...
def _task_to_response(task: Task, settings: Settings, db: Session) -> TaskResponse:
    ...
    return TaskResponse(
        ...
        asr_model_used=getattr(task, "asr_model_used", None),
        asr_compute_type_used=getattr(task, "asr_compute_type_used", None),
        video_encoder_used=getattr(task, "video_encoder_used", None),
        video_resolution_used=getattr(task, "video_resolution_used", None),
        video_width=width,
        video_height=height,
